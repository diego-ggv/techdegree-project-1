(function() {
  ...
  Treehouse.Quiz = function(i) {
    ...
    return e(s, i), s.prototype.submit = function(t, e) {
      ...
      var e, i;
      return e = Featurette.get("quiz-error-modal"), 500 === t.status ? e.setError("A server error occured while recording your answer.  Please reload the page and try again.") : (i = JSON.parse(t.responseText)).inadequate_permissions ? e.setError("You do not have access to take this Quiz. Please upgrade your account.") : i.invalid_character_in_answer ? e.setError("The following answers you gave have characters that cannot be used in answers: '" + i.invalid_character_in_answer.join("', '") + "'.  Please try again.") : e.setError("Oops! Something went wrong. Please try answering the question again."), 
      e.showOverlay({
        stack: !0
      }), this.render();
  ...
  Featurette.register("track-update-actions", function(i) {
    ...
    return e(r, i), r.prototype.declineUpdate = function() {
      ...
      return $([ "title", "description" ]).each((e = this, function(i, r) {
        var s;
        return (s = e.get("[data-track-update-" + r + "]")).html(s.data(t + "-update"));
      }));
      var e;
    }, r;
  }(Treehouse.View));
  ...
  t = function(t) {
    ...
    return i(r, t), r.prototype.onTypeChange = function(t) {
      var e;
      return "course_progress" === (e = t.currentTarget.value) || "activity" === e ? this.showDateFields() : this.hideDateFields(), 
  ...
  Featurette.register("tabbed-content", Treehouse.TabbedContent = function(i) {
    ...
    return e(r, i), r.prototype.getContent = function(t) {
      ...
      var e, i;
      return t.preventDefault(), e = (i = $(t.currentTarget)).find("a"), history.replaceState ? history.replaceState(null, null, e.attr("href")) : location.hash = e.attr("href"), 
      this.switchTabs(i);
    }, r.prototype.switchTabs = function(t) {
      if (t.addClass("current").siblings().removeClass("current"), this.showContent(t.index()), 
      this.isMobile()) return this.scrollTo(this.getContent(t.index()).offset().top);
    }, r;
  }(Treehouse.Layout));
}.call(this), function() {
  var t, e = function(t, e) {
  ...
  t = function(t) {
    ...
    return i(r, t), r.prototype.keyCodeEscape = 27, r.prototype.initTable = function() {
      ...
      var i;
      return i = t.attr("data-report-detail-type"), e < 1 ? $("a.assignment-download-CVS").addClass("hidden") : ($("a.assignment-download-CVS").removeClass("hidden"), 
      $("[data-link-download-csv]").attr("href", href + "?type=" + i));
  ...
  Featurette.register("video-player", function(i) {
    ...
    return e(r, i), r.prototype.speeds = [ .5, .75, 1, 1.1, 1.25, 1.5, 1.75, 2 ], r.prototype.onResize = function() {
      ...
      this.setSpeed(this.playbackRate), $(document).trigger("video-playing"), setTimeout(this.maxWidthState, 500);
  ...
  t = function(t) {
    function r() {
      ...
      this.get(".requirement-review-description a").attr("target", "_blank"), this.get(".expandable-content a").attr("target", "_blank"), 
      this.on("click", ".requirement-review-description a", this.stopPropagation), this.on("click", ".expandable-content a", this.stopPropagation);
    }
  ...
  Featurette.register("treehouse-email-notifications", Treehouse.TreehouseEmailNotifications = function(i) {
    ...
    return e(r, i), r.prototype.loadEloquaSubscriptions = function() {
      ...
      this.waitForGlobal("GetElqGroupMembershipStatus", (e = this, function() {
        return e.get("[data-subscription-lookup-id]").each(function() {
          var t, e;
  ...
  Featurette.register("forum-post-preview", function(i) {
    ...
    return e(r, i), r.prototype.listener = function(t) {
      ...
      (i = $.post("/community/preview", {
        post_body: e
      })).success(this.success), i.fail(this.error)) : (this.$tooltip.text("Preview"), 
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
  ...
  g.quadraticToCubic = function(t, e, i) {
    ...
    var u, c, p, d, f, g, m = /(?:\d|\-\d|\.\d|\-\.\d)+/g, y = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, _ = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, v = /(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g, b = /(?:\d|\-|\+|=|#|\.)*/g, w = /opacity *= *([^)]*)/i, k = /opacity:([^;]*)/i, T = /alpha\(opacity *=.+?\)/i, C = /^(rgb|hsl)/, x = /([A-Z])/g, S = /-([a-z])/gi, P = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, $ = function(t, e) {
      ...
      var i, r, s, n = {};
      if (e = e || X(t, null)) if (i = e.length) for (;--i > -1; ) (-1 === (s = e[i]).indexOf("-transform") || xt === s) && (n[s.replace(S, $)] = e.getPropertyValue(s)); else for (i in e) (-1 === i.indexOf("Transform") || Ct === i) && (n[i] = e[i]); else if (e = t.currentStyle || t.style) for (i in e) "string" == typeof i && void 0 === n[i] && (n[i.replace(S, $)] = e[i]);
    ...
    var kt, Tt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","), Ct = Q("transform"), xt = W + "transform", St = Q("transformOrigin"), Pt = null !== Q("perspective"), $t = I.Transform = function() {
      ...
      if (Ct ? r = K(t, xt, null, !0) : t.currentStyle && (r = (r = t.currentStyle.filter.match(D)) && 4 === r.length ? [ r[0].substr(4), Number(r[2].substr(4)), Number(r[1].substr(4)), r[3].substr(4), a.x || 0, a.y || 0 ].join(",") : ""), 
      ...
      var a, l, h, u, c, p, d = r && t._gsTransform || new $t(), f = d.scaleX < 0, g = 2e-5, m = 1e5, y = Pt && (parseFloat(K(t, St, i, !1, "0 0 0").split(" ")[2]) || d.zOrigin) || 0, _ = parseFloat(o.defaultTransformPerspective) || 0;
    ...
    h.scaleX = h.scaleY = h.scaleZ = 1, bt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
      parser: function(t, e, i, r, n, a, l) {
        ...
        if (l.display ? (p = K(t, "display"), b.display = "block", h = jt(t, s, !0, l.parseTransform), 
      ...
      parser: function(t, e, i, n, o) {
        ...
        l = 0; l < T.length; l++) this.p.indexOf("border") && (T[l] = Q(T[l])), -1 !== (c = u = K(t, T[l], s, !1, "0px")).indexOf(" ") && (c = (u = c.split(" "))[0], 
    ...
    var It = function(t) {
      ...
      e = !K(this.data, "filter")) : (i.filter = r.replace(T, ""), e = !0)), e || (this.xn1 && (i.filter = r = r || "alpha(opacity=" + s + ")"), 
    ...
    bt("opacity,alpha,autoAlpha", {
      ...
      parser: function(t, e, i, r, n, o) {
        ...
        h && 1 === a && "hidden" === K(t, "visibility", s) && 0 !== e && (a = 0), q ? n = new gt(l, "opacity", a, e - a, n) : ((n = new gt(l, "opacity", 100 * a, 100 * (e - a), n)).xn1 = h ? 1 : 0, 
    ...
    (h = o.prototype)._firstPT = h._lastParsedTransform = h._transform = null, h._onInitTween = function(t, e, a) {
      ...
      if (c && "" === T.zIndex && (("auto" === (h = K(t, "zIndex", s)) || "" === h) && this._addLazySet(T, "zIndex", 0)), 
      ...
      this._transformType) {
        for (w = 3 === this._transformType, Ct ? p && (c = !0, "" === T.zIndex && (("auto" === (v = K(t, "zIndex", s)) || "" === v) && this._addLazySet(T, "zIndex", 0)), 
      ...
      for (o in e) d = e[o], (a = l[o]) ? i = a.parse(t, d, o, this, i, n, e) : (p = K(t, o, s) + "", 
  ...
  if (!i.TweenLite) {
    ...
    var z = [], R = {}, B = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi, j = function(t) {
      ...
      "true": 1,
      "false": 0
    }, U = $._rootFramesTimeline = new D(), Q = $._rootTimeline = new D(), X = 30, K = I.lazyRender = function() {
      var t, e = z.length;
    ...
    $._updateRoot = A.render = function() {
      ...
      z.length && K(), o.frame >= X) {
        for (i in X = o.frame + (parseInt(A.autoSleep, 10) || 120), q) {
    ...
    n._init = function() {
      ...
      var n, o, a, l, h, u;
      if (null == e) return !1;
      for (n in R[e._gsTweenID] && K(), this.vars.css || e.style && e !== t && e.nodeType && L.css && !1 !== this.vars.autoCSS && E(this.vars, e), 
...
tl.to("#pinata", .5, {
  ...
  t = function(t) {
    ...
    return i(r, t), r.prototype.listenToEvents = function() {
      ...
      var e, i;
      return e = $(t.currentTarget), (i = this.el.find(".next-step:visible")).data("step", e.data("step")), 
...
//# sourceMappingURL=/assets/maps/application-04c7d41cd1f87e3f32df8473088e99412bdb19dd65152e52af72030a12293448.js.map
