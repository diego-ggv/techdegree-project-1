"function" != typeof Function.prototype.bind && (Function.prototype.bind = function(e) {
  ...
  var p, m, g, v = e.fn.init, y = e.find, b = e.parseJSON, x = /^\s*</, w = /\[(\s*[-\w]+\s*)([~|^$*]?=)\s*([-\w#]*?#[-\w#]*)\s*\]/, _ = /\[(\s*[-\w]+\s*)([~|^$*]?=)\s*([-\w#]*?#[-\w#]*)\s*\]/g, C = /^([^<]*)(<[\w\W]+>)([^>]*)$/;
  for (g in e.fn.init = function(t, r, o) {
    var s, a;
    return t && "string" == typeof t && !e.isPlainObject(r) && (s = C.exec(e.trim(t))) && s[0] && (x.test(t) || n("$(html) HTML strings must start with '<' character"), 
  ...
  e.swap && e.each([ "height", "width", "reliableMarginRight" ], function(t, i) {
    ...
    var o, s, a = {};
    for (s in S || n("jQuery.swap() is undocumented and deprecated"), t) a[s] = e.style[s], 
    e.style[s] = t[s];
  ...
  e.fn.data = function(t) {
    ...
    r !== i && r !== o || o === i) ? k.apply(this, arguments) : (n("Use of jQuery.fn.data('events') is deprecated"), 
    o);
  };
  ...
  e.clean || (e.clean = function(t, i, r, o) {
    ...
    if (e.merge(c, e.buildFragment(t, i).childNodes), r) for (l = function(e) {
      if (!e.type || T.test(e.type)) return o ? o.push(e.parentNode ? e.parentNode.removeChild(e) : e) : r.appendChild(e);
  ...
  var M = e.event.add, D = e.event.remove, A = e.event.trigger, P = e.fn.toggle, I = e.fn.live, j = e.fn.die, E = e.fn.load, F = "ajaxStart|ajaxStop|ajaxSend|ajaxComplete|ajaxError|ajaxSuccess", O = new RegExp("\\b(?:" + F + ")\\b"), N = /(?:^|\s)hover(\.\S+|)\b/, z = function(t) {
  ...
  e.event.add = function(e, t, i, r, o) {
    ...
    e.fn[i] = function() {
      ...
      return "load" === i && "string" == typeof e[0] ? E.apply(this, e) : (n("jQuery.fn." + i + "() is deprecated"), 
    ...
    return n("jQuery.fn.die() is deprecated"), j ? j.apply(this, arguments) : (e(this.context).off(t, this.selector || "**", i), 
    this);
  ...
  e.position = {
    ...
    t = e.extend({}, t);
    var o, f, m, g, v, y, b = e(t.of), x = e.position.getWithinInfo(t.within), w = e.position.getScrollInfo(x), _ = (t.collision || "flip").split(" "), C = {};
    ...
    g = y.offset, v = e.extend({}, g), e.each([ "my", "at" ], function() {
      ...
      i = d.exec(n[1]), C[this] = [ e ? e[0] : 0, i ? i[0] : 0 ], t[this] = [ h.exec(n[0])[0], h.exec(n[1])[0] ];
    }), 1 === _.length && (_[1] = _[0]), "right" === t.at[0] ? v.left += f : "center" === t.at[0] && (v.left += f / 2), 
    "bottom" === t.at[1] ? v.top += m : "center" === t.at[1] && (v.top += m / 2), o = i(C.at, f, m), 
    v.left += o[0], v.top += o[1], this.each(function() {
      var r, u, c = e(this), d = c.outerWidth(), h = c.outerHeight(), p = n(this, "marginLeft"), y = n(this, "marginTop"), S = d + p + n(this, "marginRight") + w.width, k = h + y + n(this, "marginBottom") + w.height, T = e.extend({}, v), M = i(C.my, c.outerWidth(), c.outerHeight());
      "right" === t.my[0] ? T.left -= d : "center" === t.my[0] && (T.left -= d / 2), "bottom" === t.my[1] ? T.top -= h : "center" === t.my[1] && (T.top -= h / 2), 
      T.left += M[0], T.top += M[1], e.support.offsetFractions || (T.left = l(T.left), 
      T.top = l(T.top)), r = {
        marginLeft: p,
        marginTop: y
      }, e.each([ "left", "top" ], function(i, n) {
        e.ui.position[_[i]] && e.ui.position[_[i]][n](T, {
          targetWidth: f,
          targetHeight: m,
          elemWidth: d,
          elemHeight: h,
        ...
        var i = g.left - T.left, n = i + f - d, r = g.top - T.top, o = r + m - h, l = {
          target: {
            element: b,
            left: g.left,
            top: g.top,
  ...
  var e = "object" == typeof self && self.self === self && self || "object" == typeof global && global.global === global && global || this || {}, t = e._, i = Array.prototype, n = Object.prototype, r = "undefined" != typeof Symbol ? Symbol.prototype : null, o = i.push, s = i.slice, a = n.toString, l = n.hasOwnProperty, u = Array.isArray, c = Object.keys, d = Object.create, h = function() {}, f = function(e) {
    return e instanceof f ? e : this instanceof f ? void (this._wrapped = e) : new f(e);
  };
  "undefined" == typeof exports || exports.nodeType ? e._ = f : ("undefined" != typeof module && !module.nodeType && module.exports && (exports = module.exports = f), 
  exports._ = f), f.VERSION = "1.9.1";
  var p, m = function(e, t, i) {
    ...
    return f.iteratee !== p ? f.iteratee(e, t) : null == e ? f.identity : f.isFunction(e) ? m(e, t, i) : f.isObject(e) && !f.isArray(e) ? f.matcher(e) : f.property(e);
  };
  f.iteratee = p = function(e, t) {
  ...
  var v = function(e, t) {
    ...
    return i ? e : void 0;
  }, _ = Math.pow(2, 53) - 1, C = b("length"), S = function(e) {
    var t = C(e);
    return "number" == typeof t && t >= 0 && t <= _;
  };
  f.each = f.forEach = function(e, t, i) {
    var n, r;
    if (t = m(t, i), S(e)) for (n = 0, r = e.length; n < r; n++) t(e[n], n, e); else {
      var o = f.keys(e);
    ...
    t = g(t, i);
    for (var n = !S(e) && f.keys(e), r = (n || e).length, o = Array(r), s = 0; s < r; s++) {
      var a = n ? n[s] : s;
      o[s] = t(e[a], a, e);
    }
    return o;
  ...
  var k = function(e) {
    var t = function(t, i, n, r) {
      var o = !S(t) && f.keys(t), s = (o || t).length, a = e > 0 ? 0 : s - 1;
    ...
    return function(e, i, n, r) {
      ...
      return t(e, m(i, r, 4), n, o);
    };
  };
  f.reduce = f.foldl = f.inject = k(1), f.reduceRight = f.foldr = k(-1), f.find = f.detect = function(e, t, i) {
    var n = (S(e) ? f.findIndex : f.findKey)(e, t, i);
    if (void 0 !== n && -1 !== n) return e[n];
  }, f.filter = f.select = function(e, t, i) {
    var n = [];
    return t = g(t, i), f.each(e, function(e, i, r) {
      t(e, i, r) && n.push(e);
    }), n;
  }, f.reject = function(e, t, i) {
    return f.filter(e, f.negate(g(t)), i);
  }, f.every = f.all = function(e, t, i) {
    t = g(t, i);
    for (var n = !S(e) && f.keys(e), r = (n || e).length, o = 0; o < r; o++) {
      var s = n ? n[o] : o;
      if (!t(e[s], s, e)) return !1;
    }
    return !0;
  }, f.some = f.any = function(e, t, i) {
    t = g(t, i);
    for (var n = !S(e) && f.keys(e), r = (n || e).length, o = 0; o < r; o++) {
      var s = n ? n[o] : o;
    ...
    return !1;
  }, f.contains = f.includes = f.include = function(e, t, i, n) {
    return S(e) || (e = f.values(e)), ("number" != typeof i || n) && (i = 0), f.indexOf(e, t, i) >= 0;
  }, f.invoke = v(function(e, t, i) {
    var n, r;
    return f.isFunction(t) ? r = t : f.isArray(t) && (n = t.slice(0, -1), t = t[t.length - 1]), 
    f.map(e, function(e) {
      var o = r;
      if (!o) {
        if (n && n.length && (e = w(e, n)), null == e) return;
        o = e[t];
      }
  ...
  }, f.max = function(e, t, i) {
    var n, r, o = -Infinity, s = -Infinity;
    if (null == t || "number" == typeof t && "object" != typeof e[0] && null != e) for (var a = 0, l = (e = S(e) ? e : f.values(e)).length; a < l; a++) null != (n = e[a]) && n > o && (o = n); else t = g(t, i), 
    f.each(e, function(e, i, n) {
      ((r = t(e, i, n)) > s || r === -Infinity && o === -Infinity) && (o = e, s = r);
    });
    return o;
    ...
    return f.sample(e, Infinity);
  }, f.sample = function(e, t, i) {
    if (null == t || i) return S(e) || (e = f.values(e)), e[f.random(e.length - 1)];
    var n = S(e) ? f.clone(e) : f.values(e), r = C(n);
    t = Math.max(Math.min(t, r), 0);
    for (var o = r - 1, s = 0; s < t; s++) {
      var a = f.random(s, o), l = n[s];
      n[s] = n[a], n[a] = l;
    }
    return n.slice(0, t);
  }, f.sortBy = function(e, t, i) {
    var n = 0;
    return t = g(t, i), f.pluck(f.map(e, function(e, i, r) {
      return {
        value: e,
        index: n++,
        criteria: t(e, i, r)
  ...
  var T = function(e, t) {
    return function(i, n, r) {
      var o = t ? [ [], [] ] : {};
      return n = g(n, r), f.each(i, function(t, r) {
        var s = n(t, r, i);
        e(o, t, s);
      }), o;
    };
  };
  f.groupBy = T(function(e, t, i) {
    x(e, i) ? e[i].push(t) : e[i] = [ t ];
  }), f.indexBy = T(function(e, t, i) {
    e[i] = t;
  }), f.countBy = T(function(e, t, i) {
    x(e, i) ? e[i]++ : e[i] = 1;
  });
  var M = /[^\ud800-\udfff]|[\ud800-\udbff][\udc00-\udfff]|[\ud800-\udfff]/g;
  f.toArray = function(e) {
    return e ? f.isArray(e) ? s.call(e) : f.isString(e) ? e.match(M) : S(e) ? f.map(e, f.identity) : f.values(e) : [];
  }, f.size = function(e) {
    return null == e ? 0 : S(e) ? e.length : f.keys(e).length;
  }, f.partition = T(function(e, t, i) {
    e[i ? 0 : 1].push(t);
  }, !0), f.first = f.head = f.take = function(e, t, i) {
    return null == e || e.length < 1 ? null == t ? void 0 : [] : null == t || i ? e[0] : f.initial(e, e.length - t);
  }, f.initial = function(e, t, i) {
    return s.call(e, 0, Math.max(0, e.length - (null == t || i ? 1 : t)));
  }, f.last = function(e, t, i) {
    return null == e || e.length < 1 ? null == t ? void 0 : [] : null == t || i ? e[e.length - 1] : f.rest(e, Math.max(0, e.length - t));
  }, f.rest = f.tail = f.drop = function(e, t, i) {
    return s.call(e, null == t || i ? 1 : t);
  }, f.compact = function(e) {
    return f.filter(e, Boolean);
  };
  var D = function(e, t, i, n) {
    for (var r = (n = n || []).length, o = 0, s = C(e); o < s; o++) {
      var a = e[o];
      if (S(a) && (f.isArray(a) || f.isArguments(a))) if (t) for (var l = 0, u = a.length; l < u; ) n[r++] = a[l++]; else D(a, t, i, n), 
  ...
  }), f.uniq = f.unique = function(e, t, i, n) {
    f.isBoolean(t) || (n = i, i = t, t = !1), null != i && (i = g(i, n));
    for (var r = [], o = [], s = 0, a = C(e); s < a; s++) {
      var l = e[s], u = i ? i(l, s, e) : l;
      t && !i ? (s && o === u || r.push(l), o = u) : i ? f.contains(o, u) || (o.push(u), 
      r.push(l)) : f.contains(r, l) || r.push(l);
    }
    return r;
  }, f.union = v(function(e) {
    return f.uniq(D(e, !0, !0));
  }), f.intersection = function(e) {
    for (var t = [], i = arguments.length, n = 0, r = C(e); n < r; n++) {
      var o = e[n];
      if (!f.contains(t, o)) {
        var s;
        for (s = 1; s < i && f.contains(arguments[s], o); s++) ;
        s === i && t.push(o);
      }
    }
    return t;
  }, f.difference = v(function(e, t) {
    return t = D(t, !0, !0), f.filter(e, function(e) {
      return !f.contains(t, e);
    });
  }), f.unzip = function(e) {
    for (var t = e && f.max(e, C).length || 0, i = Array(t), n = 0; n < t; n++) i[n] = f.pluck(e, n);
    return i;
  ...
  var A = function(e) {
    return function(t, i, n) {
      i = g(i, n);
      for (var r = C(t), o = e > 0 ? 0 : r - 1; o >= 0 && o < r; o += e) if (i(t[o], o, t)) return o;
      return -1;
    };
  };
  f.findIndex = A(1), f.findLastIndex = A(-1), f.sortedIndex = function(e, t, i, n) {
    for (var r = (i = g(i, n, 1))(t), o = 0, s = C(e); o < s; ) {
  ...
  var P = function(e, t, i) {
    return function(n, r, o) {
      var a = 0, l = C(n);
      if ("number" == typeof o) e > 0 ? a = o >= 0 ? o : Math.max(o + l, a) : l = o >= 0 ? Math.min(o + 1, l) : o + l + 1; else if (i && o && l) return n[o = i(n, r)] === r ? o : -1;
      if (r != r) return (o = t(s.call(n, a, l), f.isNaN)) >= 0 ? o + a : -1;
      for (o = e > 0 ? a : l - 1; o >= 0 && o < l; o += e) if (n[o] === r) return o;
      return -1;
    };
  };
  f.indexOf = P(1, f.findIndex, f.sortedIndex), f.lastIndexOf = P(-1, f.findLastIndex), 
  ...
  var I = function(e, t, i, n, r) {
    ...
    var o = y(e.prototype), s = e.apply(o, r);
    return f.isObject(s) ? s : o;
  };
  f.bind = v(function(e, t, i) {
    if (!f.isFunction(e)) throw new TypeError("Bind must be called on a function");
    var n = v(function(r) {
      return I(e, n, t, this, i.concat(r));
    });
    return n;
  }), f.partial = v(function(e, t) {
    var i = f.partial.placeholder, n = function() {
    ...
    return n;
  }), f.partial.placeholder = f, f.bindAll = v(function(e, t) {
    ...
    var i = function(n) {
      ...
      return x(r, o) || (r[o] = e.apply(this, arguments)), r[o];
    };
    return i.cache = {}, i;
  }, f.delay = v(function(e, t, i) {
    return setTimeout(function() {
      return e.apply(null, i);
    }, t);
  }), f.defer = f.partial(f.delay, f, 1), f.throttle = function(e, t, i) {
    var n, r, o, s, a = 0;
    i || (i = {});
    var l = function() {
      a = !1 === i.leading ? 0 : f.now(), n = null, s = e.apply(r, o), n || (r = o = null);
    }, u = function() {
      var u = f.now();
      a || !1 !== i.leading || (a = u);
      var c = t - (u - a);
  ...
  }, f.debounce = function(e, t, i) {
    var n, r, o = function(t, i) {
      n = null, i && (r = e.apply(t, i));
    }, s = v(function(s) {
      if (n && clearTimeout(n), i) {
        var a = !n;
        n = setTimeout(o, t), a && (r = e.apply(this, s));
      } else n = f.delay(o, t, this, s);
      return r;
    });
  ...
  var j = !{
    toString: null
  }.propertyIsEnumerable("toString"), E = [ "valueOf", "isPrototypeOf", "toString", "propertyIsEnumerable", "hasOwnProperty", "toLocaleString" ], F = function(e, t) {
    var i = E.length, r = e.constructor, o = f.isFunction(r) && r.prototype || n, s = "constructor";
    for (x(e, s) && !f.contains(t, s) && t.push(s); i--; ) (s = E[i]) in e && e[s] !== o[s] && !f.contains(t, s) && t.push(s);
  };
  f.keys = function(e) {
    if (!f.isObject(e)) return [];
    if (c) return c(e);
    var t = [];
    for (var i in e) x(e, i) && t.push(i);
    return j && F(e, t), t;
    ...
    for (var t = f.keys(e), i = t.length, n = Array(i), r = 0; r < i; r++) n[r] = e[t[r]];
    return n;
  }, f.mapObject = function(e, t, i) {
    t = g(t, i);
    for (var n = f.keys(e), r = n.length, o = {}, s = 0; s < r; s++) {
      var a = n[s];
      o[a] = t(e[a], a, e);
    }
    return o;
  }, f.pairs = function(e) {
    for (var t = f.keys(e), i = t.length, n = Array(i), r = 0; r < i; r++) n[r] = [ t[r], e[t[r]] ];
    return n;
  }, f.invert = function(e) {
    for (var t = {}, i = f.keys(e), n = 0, r = i.length; n < r; n++) t[e[i[n]]] = i[n];
    return t;
  ...
  f.extend = O(f.allKeys), f.extendOwn = f.assign = O(f.keys), f.findKey = function(e, t, i) {
    t = g(t, i);
    for (var n, r = f.keys(e), o = 0, s = r.length; o < s; o++) if (t(e[n = r[o]], n, e)) return n;
  };
  var N, z, L = function(e, t, i) {
    return t in i;
  };
  f.pick = v(function(e, t) {
    var i = {}, n = t[0];
    if (null == e) return i;
    f.isFunction(n) ? (t.length > 1 && (n = m(n, t[1])), t = f.allKeys(e)) : (n = L, 
    t = D(t, !1, !1), e = Object(e));
    for (var r = 0, o = t.length; r < o; r++) {
      var s = t[r], a = e[s];
      n(a, s, e) && (i[s] = a);
    }
    return i;
  }), f.omit = v(function(e, t) {
    var i, n = t[0];
    return f.isFunction(n) ? (n = f.negate(n), t.length > 1 && (i = t[1])) : (t = f.map(D(t, !1, !1), String), 
    n = function(e, i) {
      return !f.contains(t, i);
    }), f.pick(e, n, i);
  }), f.defaults = O(f.allKeys, !0), f.create = function(e, t) {
    var i = y(e);
    return t && f.extendOwn(i, t), i;
  }, f.clone = function(e) {
    return f.isObject(e) ? f.isArray(e) ? e.slice() : f.extend({}, e) : e;
  }, f.tap = function(e, t) {
    return t(e), e;
  }, f.isMatch = function(e, t) {
    var i = f.keys(t), n = i.length;
    if (null == e) return !n;
    ...
    if (e != e) return t != t;
    var r = typeof e;
    return ("function" === r || "object" === r || "object" == typeof t) && z(e, t, i, n);
  }, z = function(e, t, i, n) {
    ...
    if (!s) {
      ...
      if (l !== u && !(f.isFunction(l) && l instanceof l && f.isFunction(u) && u instanceof u) && "constructor" in e && "constructor" in t) return !1;
    }
    n = n || [];
    for (var c = (i = i || []).length; c--; ) if (i[c] === e) return n[c] === t;
    if (i.push(e), n.push(t), s) {
      if ((c = e.length) !== t.length) return !1;
      for (;c--; ) if (!N(e[c], t[c], i, n)) return !1;
    } else {
      var d, h = f.keys(e);
      if (c = h.length, f.keys(t).length !== c) return !1;
      for (;c--; ) if (d = h[c], !x(t, d) || !N(e[d], t[d], i, n)) return !1;
    }
    return i.pop(), n.pop(), !0;
  }, f.isEqual = function(e, t) {
    return N(e, t);
  }, f.isEmpty = function(e) {
    return null == e || (S(e) && (f.isArray(e) || f.isString(e) || f.isArguments(e)) ? 0 === e.length : 0 === f.keys(e).length);
  ...
  }, f.each([ "Arguments", "Function", "String", "Number", "Date", "RegExp", "Error", "Symbol", "Map", "WeakMap", "Set", "WeakSet" ], function(e) {
    f["is" + e] = function(t) {
  ...
  "function" != typeof /./ && "object" != typeof Int8Array && "function" != typeof R && (f.isFunction = function(e) {
    ...
    if (!f.isArray(t)) return x(e, t);
    for (var i = t.length, n = 0; n < i; n++) {
      var r = t[n];
      if (null == e || !l.call(e, r)) return !1;
      e = e[r];
    }
    return !!i;
    ...
    return f.isArray(e) ? function(t) {
      return w(t, e);
    } : b(e);
  }, f.propertyOf = function(e) {
    return null == e ? function() {} : function(t) {
      return f.isArray(t) ? w(e, t) : e[t];
    };
  ...
  var H = {
    ...
    "'": "&#x27;",
    "`": "&#x60;"
  }, W = f.invert(H), B = function(e) {
    var t = function(t) {
      return e[t];
    }, i = "(?:" + f.keys(e).join("|") + ")", n = RegExp(i), r = RegExp(i, "g");
    return function(e) {
      return e = null == e ? "" : "" + e, n.test(e) ? e.replace(r, t) : e;
    };
  };
  f.escape = B(H), f.unescape = B(W), f.result = function(e, t, i) {
    f.isArray(t) || (t = [ t ]);
    var n = t.length;
    if (!n) return f.isFunction(i) ? i.call(e) : i;
    for (var r = 0; r < n; r++) {
      var o = null == e ? void 0 : e[t[r]];
      void 0 === o && (o = i, r = n), e = f.isFunction(o) ? o.call(e) : o;
    }
    return e;
  };
  var $ = 0;
  ...
  f.template = function(e, t, i) {
    !t && i && (t = i), t = f.defaults({}, t, f.templateSettings);
    var n, r = RegExp([ (t.escape || V).source, (t.interpolate || V).source, (t.evaluate || V).source ].join("|") + "|$", "g"), o = 0, s = "__p+='";
    e.replace(r, function(t, i, n, r, a) {
      return s += e.slice(o, a).replace(q, Y), o = a + t.length, i ? s += "'+\n((__t=(" + i + "))==null?'':_.escape(__t))+\n'" : n ? s += "'+\n((__t=(" + n + "))==null?'':__t)+\n'" : r && (s += "';\n" + r + "\n__p+='"), 
      t;
  ...
  f.mixin = function(e) {
    return f.each(f.functions(e), function(t) {
      var i = f[t] = e[t];
      f.prototype[t] = function() {
        var e = [ this._wrapped ];
        return o.apply(e, arguments), X(this, i.apply(f, e));
      };
    }), f;
  ...
  m() && !g() && (S = !1), t.uniform = {
    ...
    var n = this;
    return i = t.extend({}, t.uniform.defaults, i), k || (k = !0, f() && (S = !1)), 
    S ? (i.resetSelector && t(i.resetSelector).mouseup(function() {
      ...
      var e, n, r, o = t(this);
      if (o.data("uniformed")) t.uniform.update(o); else for (e = 0; e < T.length; e += 1) if ((n = T[e]).match(o, i)) return r = n.apply(o, i), 
  ...
  function S() {
    e.fn.pjax = t, e.pjax = r, e.pjax.enable = e.noop, e.pjax.disable = k, e.pjax.click = i, 
  ...
  function k() {
    e.fn.pjax = function() {
      return this;
    }, e.pjax = l, e.pjax.enable = S, e.pjax.disable = e.noop, e.pjax.click = e.noop, 
    e.pjax.submit = e.noop, e.pjax.reload = function() {
      window.location.reload();
    }, e(window).off("popstate.pjax", a);
  }
  var T = !0, M = window.location.href, D = window.history.state;
  D && D.container && (r.state = D), "state" in window.history && (T = !1);
  var A = {}, P = [], I = [];
  ...
  var i = {
    ...
    function s() {
      "true" != (T = e(k)).attr("data-mentions-input") && (M = T.parent(), A = e(o.templates.wrapper()), 
      T.wrapAll(A), A = M.find("> div.mentions-input-box"), T.attr("data-mentions-input", "true"), 
      T.bind("keydown", b), T.bind("keypress", y), T.bind("input", v), T.bind("click", m), 
      T.bind("blur", g), o.elastic && T.elastic());
    }
    function a() {
      (D = e(o.templates.autocompleteList())).appendTo(A), D.delegate("li", "mousedown", p);
    }
    function l() {
      (P = e(o.templates.mentionsOverlay())).prependTo(A);
    }
    function u() {
      var e = f();
      t.each(E, function(t) {
      ...
      t.each(E, function(e) {
        ...
        i = i.replace(s, a);
      }), i = (i = i.replace(/\n/g, "<br />")).replace(/ {2}/g, "&nbsp; "), T.data("messageText", e), 
      P.find("div").html(i);
    }
    function c() {
      O = [];
    ...
    function d() {
      var e = f();
      E = t.reject(E, function(t) {
        return !t.value || -1 == e.indexOf(t.value);
      }), E = t.compact(E);
    }
    function h(e) {
      var t = f(), i = new RegExp("\\" + o.triggerChar + j, "gi");
      if (match = i.exec(t), match) {
        var n = i.lastIndex - j.length - 1, s = i.lastIndex, a = t.substr(0, n), l = t.substr(s, t.length), d = (a + e.value).length;
        o.insertSpaceAfterMention && (d += 1), E.push(e), c(), j = "", x();
        var h = a + e.value;
        o.insertSpaceAfterMention && (h += " "), h += l, T.val(h), u(), T.focus(), r.setCaratPosition(T[0], d);
      }
    }
    function f() {
      return e.trim(T.val());
    ...
    function v() {
      u(), d();
      var e = t.lastIndexOf(O, o.triggerChar);
      e > -1 && (j = O.slice(e + 1).join(""), j = r.rtrim(j), t.defer(t.bind(C, this, j)));
    }
    function y(e) {
    ...
    function b(n) {
      ...
      if (n.keyCode != i.BACKSPACE) {
        ...
        switch (n.keyCode) {
         ...
         case i.DOWN:
          var r = null;
          return (r = n.keyCode == i.DOWN ? I && I.length ? I.next() : D.find("li").first() : e(I).prev()).length && w(r), 
          !1;

         case i.RETURN:
         case i.TAB:
          return !I || !I.length || (I.trigger("mousedown"), !1);
        }
        return !0;
      }
      O = O.slice(0, -1 + O.length);
    }
    function x() {
      I = null, D.empty().hide();
    }
    ...
    function _(i, n) {
      D.show();
      var s = t.pluck(E, "value");
      if ((n = t.reject(n, function(e) {
        return t.include(s, e.name);
      })).length) {
        D.empty();
        var a = e("<ul>").appendTo(D).hide();
        t.each(n, function(n, s) {
          ...
          (0 === s && w(u), o.showAvatars) && (n.avatar ? e(o.templates.autocompleteListItemAvatar({
            avatar: n.avatar,
            type: n.type
    ...
    var k, T, M, D, A, P, I, j, E = [], F = {}, O = [];
    return o = e.extend(!0, {}, n, o), {
      init: function(e) {
        k = e, s(), a(), l(), S(), o.prefillMention && h(o.prefillMention);
      },
      val: function(e) {
        if (t.isFunction(e)) {
          var i = E.length ? T.data("messageText") : f();
          e.call(this, i);
        }
      },
      reset: function() {
      ...
      getMentions: function(e) {
        t.isFunction(e) && e.call(this, E);
      },
      setMentions: function(e, i) {
        T.val(e), insertSpace = o.insertSpaceAfterMention, o.insertSpaceAfterMention = !1, 
        t.each(i, function(e) {
          e.value = e.name, j = e.value, h(e);
  ...
  return function e(t, i, n) {
    ...
    4: [ function(e, t) {
      ...
      for (var k in C) S[JSON.stringify(C[k])] = k;
    }, {} ],
    5: [ function(e, t) {
        ...
        e.controllers.bar = e.DatasetController.extend({
          ...
          calculateBarIndexPixels: function(e, t, i) {
            ...
            l = 1), {
              ...
              ratio: l,
              start: d - a / 2
            }), C = this.getStackIndex(e, this.getMeta().stack), S = _.start + _.chunk * C + _.chunk / 2, k = Math.min(r.valueOrDefault(w.maxBarThickness, 1 / 0), _.chunk * _.ratio);
            return {
              base: S - k / 2,
              head: S + k / 2,
              center: S,
      ...
      i._set("doughnut", {
        ...
        e.controllers.doughnut = e.controllers.pie = e.DatasetController.extend({
          ...
          update: function(e) {
            ...
            if (f < 2 * Math.PI) {
              var p = o.rotation % (2 * Math.PI), m = (p += 2 * Math.PI * (p >= Math.PI ? -1 : p < -Math.PI ? 1 : 0)) + f, g = Math.cos(p), v = Math.sin(p), y = Math.cos(m), b = Math.sin(m), x = p <= 0 && m >= 0 || p <= 2 * Math.PI && 2 * Math.PI <= m, w = p <= .5 * Math.PI && .5 * Math.PI <= m || p <= 2.5 * Math.PI && 2.5 * Math.PI <= m, _ = p <= -Math.PI && -Math.PI <= m || p <= Math.PI && Math.PI <= m, C = p <= .5 * -Math.PI && .5 * -Math.PI <= m || p <= 1.5 * Math.PI && 1.5 * Math.PI <= m, S = h / 100, k = _ ? -1 : Math.min(g * (g < 0 ? 1 : S), y * (y < 0 ? 1 : S)), T = C ? -1 : Math.min(v * (v < 0 ? 1 : S), b * (b < 0 ? 1 : S)), M = x ? 1 : Math.max(g * (g > 0 ? 1 : S), y * (y > 0 ? 1 : S)), D = w ? 1 : Math.max(v * (v > 0 ? 1 : S), b * (b > 0 ? 1 : S)), A = .5 * (M - k), P = .5 * (D - T);
        ...
        update: function(e, t, o) {
          function s(e) {
            ...
            if (t) if (e.isHorizontal()) {
              ...
              e.update(e.fullWidth ? b : S, x / 2, i);
            } else e.update(t.minSize.width, k);
          }
          function a(e) {
            e.isHorizontal() ? (e.left = e.fullWidth ? c : I, e.right = e.fullWidth ? t - d : I + S, 
            e.top = H, e.bottom = H + e.height, H = e.bottom) : (e.left = R, e.right = R + e.width, 
            e.top = E, e.bottom = E + k, R = e.right);
          }
          if (e) {
            ...
            var b = t - c - d, x = o - h - f, w = x / 2, _ = (t - b / 2) / (p.length + m.length), C = (o - w) / (g.length + v.length), S = b, k = x, T = [];
            r.each(p.concat(m, g, v), function(e) {
              var t, i = e.isHorizontal();
              i ? (t = e.update(e.fullWidth ? b : S, C), k -= t.height) : (t = e.update(_, k), 
              S -= t.width), T.push({
                horizontal: i,
                minSize: t,
                box: e
            ...
            }), I = c, j = d, E = h, F = f, r.each(p, function(e) {
              I += e.width;
            }), r.each(m, function(e) {
              j += e.width;
            }), r.each(g, function(e) {
            ...
            I += O, j += Math.max(D - j, 0);
            var N = Math.max(A - E, 0);
            E += N, F += Math.max(P - F, 0);
            var z = o - E - F, L = t - I - j;
            L === S && z === k || (r.each(p, function(e) {
              e.height = z;
            }), r.each(m, function(e) {
              e.height = z;
            }), r.each(g, function(e) {
            ...
            var R = c + O, H = h + N;
            r.each(p.concat(g), a), R += S, H += k, r.each(m, a), r.each(v, a), e.chartArea = {
              left: I,
              top: E,
              right: I + S,
              bottom: E + k
              ...
              t.bottom = e.chartArea.bottom, t.update(S, k);
            });
          }
        }
      };
          ...
          fit: function() {
            ...
            if (u.display && h) {
              ...
              if (f) {
                ...
                var w = s.toRadians(e.labelRotation), _ = Math.cos(w), C = Math.sin(w) * v + p.size * y + b * (y - 1) + b;
                n.height = Math.min(e.maxHeight, n.height + C + x), e.ctx.font = p.font;
                var S = t(e.ctx, r[0], p.font), k = t(e.ctx, r[r.length - 1], p.font);
                0 !== e.labelRotation ? (e.paddingLeft = "bottom" === o.position ? _ * S + 3 : _ * b + 3, 
                e.paddingRight = "bottom" === o.position ? _ * b + 3 : _ * k + 3) : (e.paddingLeft = S / 2 + 3, 
                e.paddingRight = k / 2 + 3);
          ...
          draw: function(e) {
            ...
            if (i.display) {
              ...
              if (s.each(g, function(r, o) {
                ...
                var j, E, F = 0, O = l(f) / 2;
                if (m) j = t.left + (t.right - t.left) / 2, E = "bottom" === i.position ? t.bottom - O - S.bottom : t.top + O + S.top; else {
                  var N = "left" === i.position;
                  j = N ? t.left + O + S.top : t.right - O - S.top, E = t.top + (t.bottom - t.top) / 2, 
                  F = N ? -.5 * Math.PI : .5 * Math.PI;
                }
                o.save(), o.translate(j, E), o.rotate(F), o.textAlign = "center", o.textBaseline = "middle", 
                o.fillStyle = _, o.font = C.font, o.fillText(f.labelString, 0, 0), o.restore();
              }
              if (h.drawBorder) {
    ...
    35: [ function(e, t) {
      ...
      i._set("global", {
        ...
        e.Tooltip = n.extend({
          ...
          update: function(t) {
            var i, n, o, a, l, u, c, d, h, f, p, m, g, v, y, b, x, w, _, C, S = this, k = S._options, T = S._model, M = S._model = s(k), D = S._active, A = S._data, P = {
              xAlign: T.xAlign,
              yAlign: T.yAlign
            }, I = {
              x: T.x,
            ...
            if (D.length) {
              M.opacity = 1;
              var F = [], O = [];
              E = e.Tooltip.positioners[k.position].call(S, D, S._eventPosition);
              var N = [];
              for (i = 0, n = D.length; i < n; ++i) N.push((x = void 0, w = void 0, x = (b = D[i])._xScale, 
              w = b._yScale || b._scale, _ = b._index, C = b._datasetIndex, {
                xLabel: x ? x.getLabelForIndex(_, C) : "",
                yLabel: w ? w.getLabelForIndex(_, C) : "",
                index: _,
                datasetIndex: C,
                x: b._model.x,
                y: b._model.y
              }));
              k.filter && (N = N.filter(function(e) {
                return k.filter(e, A);
              })), k.itemSort && (N = N.sort(function(e, t) {
                return k.itemSort(e, t, A);
              })), r.each(N, function(e) {
                F.push(k.callbacks.labelColor.call(S, e, S._chart)), O.push(k.callbacks.labelTextColor.call(S, e, S._chart));
              }), M.title = S.getTitle(N, A), M.beforeBody = S.getBeforeBody(N, A), M.body = S.getBody(N, A), 
              M.afterBody = S.getAfterBody(N, A), M.footer = S.getFooter(N, A), M.x = Math.round(E.x), 
              M.y = Math.round(E.y), M.caretPadding = k.caretPadding, M.labelColors = F, M.labelTextColors = O, 
              ...
              }(this, M)), o = M, a = j, l = P, u = S._chart, c = o.x, d = o.y, h = o.caretSize, 
            ...
            return M.xAlign = P.xAlign, M.yAlign = P.yAlign, M.x = I.x, M.y = I.y, M.width = j.width, 
            M.height = j.height, M.caretX = E.x, M.caretY = E.y, S._model = M, t && k.custom && k.custom.call(S, M), 
            S;
          },
      ...
      var u = o.extend({
        ...
        fit: function() {
          ...
          o) if (a.font = f, g) {
            ...
            var b = n.padding, x = e.columnWidths = [], w = n.padding, _ = 0, C = 0, S = c + b;
            s.each(e.legendItems, function(e, t) {
              var r = i(n, c) + c / 2 + a.measureText(e.text).width;
              C + S > m.height && (w += _ + n.padding, x.push(_), _ = 0, C = 0), _ = Math.max(_, r), 
              C += S, p[t] = {
                left: 0,
                top: 0,
                width: r,
        ...
        draw: function() {
          ...
          if (t.display) {
            ...
            s.each(e.legendItems, function(i, r) {
              var f, m, g, v, _, C = d.measureText(i.text).width, S = y + p / 2 + C, k = c.x, T = c.y;
              x ? k + S >= l && (T = c.y += w, c.line++, k = c.x = e.left + (l - u[c.line]) / 2) : T + w > e.bottom && (k = c.x = k + e.columnWidths[c.line] + n.padding, 
              T = c.y = e.top + n.padding, c.line++), function(e, i, n) {
                if (!(isNaN(y) || y <= 0)) {
              ...
              }(k, T, i), b[r].left = k, b[r].top = T, f = i, m = C, v = y + (g = p / 2) + k, 
              _ = T + g, d.fillText(f.text, v, _), f.hidden && (d.beginPath(), d.lineWidth = 2, 
              d.moveTo(v, _), d.lineTo(v + m, _), d.stroke()), x ? c.x += S + n.padding : c.y += w;
            });
          }
        },
        handleEvent: function(e) {
      ...
      var l = r.extend({
        ...
        draw: function() {
          ...
          if (r.display) {
            ...
            var w = r.text;
            if (o.isArray(w)) for (var _ = 0, C = 0; C < w.length; ++C) t.fillText(w[C], 0, _, a), 
    ...
    58: [ function(e, t) {
      ...
      t.exports = function(e) {
        var t = e.Scale.extend({
          ...
          buildTicks: function() {
            var e, t, i, n, c, d, h, f, g, v, y, b, x = this, w = x.min, _ = x.max, C = x.options, S = C.time, k = [], T = [];
            switch (C.ticks.source) {
             case "data":
              k = x._timestamps.data;
              break;

             case "labels":
              k = x._timestamps.labels;
              break;

             case "auto":
             default:
              k = l(w, _, x.getLabelCapacity(w), C);
            }
            for ("ticks" === C.bounds && k.length && (w = k[0], _ = k[k.length - 1]), w = s(S.min, x) || w, 
            _ = s(S.max, x) || _, e = 0, t = k.length; e < t; ++e) (i = k[e]) >= w && i <= _ && T.push(i);
            return x.min = w, x.max = _, x._unit = S.unit || function(e, t, i, n) {
            ...
            }(T, S.minUnit, x.min, x.max), x._majorUnit = a(x._unit), x._table = function(e, t, i) {
              if ("linear" === C.distribution || !e.length) return [ {
                time: t,
                pos: 0
              }, {
                time: i,
              ...
              return l;
            }(x._timestamps.data, w, _), x._offsets = (n = x._table, c = T, d = w, h = _, y = 0, 
            b = 0, (f = C).offset && c.length && (f.time.min || (g = c.length > 1 ? c[1] : h, 
            ...
            }(x._timestamps.data, S), function(e, t) {
              var i, n, r, o, s = [];
  ...
  return function(e, t, i) {
    ...
    i.Svg.Easing = k, i.Svg.List = i.Class.extend({
      constructor: S
    });
  }(window, document, e), function(e, t, i) {
    "use strict";
      ...
      u.raw.series.forEach(function(e, t) {
        ...
        if (0 !== u.normalized.series[s] || !e.ignoreEmptyValues) {
          ...
          if (x.attr({
            ...
            var C = e.labelInterpolationFnc(_, s);
            if (C || 0 === C) {
              var S = t.elem("text", {
                dx: w.x,
                dy: w.y,
...
!function(e, t) {
  ...
  e.tags = {
    ...
    function u(e, t) {
      var n = "=" + S, r = e.indexOf(n, t), o = i(e.substring(e.indexOf("=", t) + 1, r)).split(" ");
      return C = o[0], S = o[o.length - 1], r + n.length - 1;
    }
    var c = r.length, d = 0, h = 1, f = 2, m = d, g = null, v = null, y = "", b = [], x = !1, w = 0, _ = 0, C = "{{", S = "}}";
    for (o && (o = o.split(" "), C = o[0], S = o[1]), w = 0; w < c; w++) m == d ? n(C, r, w) ? (--w, 
    s(), m = h) : "\n" == r.charAt(w) ? l(x) : y += r.charAt(w) : m == h ? (w += C.length - 1, 
    "=" == (g = (v = e.tags[r.charAt(w + 1)]) ? r.charAt(w + 1) : "_v") ? (w = u(r, w), 
    m = d) : (v && w++, m = f), x = w) : n(S, r, w) ? (b.push({
      tag: g,
      n: i(y),
      otag: C,
      ctag: S,
      i: "/" == g ? x - C.length : w + S.length
    }), y = "", w += S.length - 1, m = d, "{" == g && ("}}" == S ? w++ : t(b[b.length - 1]))) : y += r.charAt(w);
    return l(x, !0), b;
  };
  var b = {
    _t: !0,
...
Zepto.fn.outerWidth = function(e) {
  ...
  var t = e.tablesorter = {
    ...
    buildCache: function(i, n, r) {
      var o, s, a, l, u, c, d, h, f, p, m, g, v, y, b, x, w, _, C, S, k, T, M = i.table, D = i.parsers, A = t.debug(i, "core");
      ...
      for (A && (g = new Date()), i.showProcessing && t.isProcessing(M, !0), c = 0; c < d.length; c++) {
        for (x = [], o = i.cache[c] = {
          ...
          child: [],
          raw: []
        }, f = [], !(h = e(d[c].rows[l])).hasClass(i.selectorRemove.slice(1))) if (h.hasClass(i.cssChildRow) && 0 !== l) for (k = o.normalized.length - 1, 
        (b = o.normalized[k][i.columns]).$row = b.$row.add(h), h.prev().hasClass(i.cssChildRow) || h.prev().addClass(t.css.cssHasChild), 
        p = h.children("th, td"), k = b.child.length, b.child[k] = [], _ = 0, S = i.columns, 
        u = 0; u < S; u++) (m = p[u]) && (b.child[k][u] = t.getParsedText(i, m, u), (w = p[u].colSpan - 1) > 0 && (_ += w, 
        S += w)), _++; else {
          for (y.$row = h, y.order = l, _ = 0, S = i.columns, u = 0; u < S; ++u) {
            if ((m = h[0].cells[u]) && _ < i.columns && (!(C = "undefined" != typeof D[_]) && A && console.warn("No parser found for row: " + l + ", column: " + u + '; cell containing: "' + e(m).text() + '"; does it have a header?'), 
            s = t.getElementText(i, m, _), y.raw[_] = s, a = t.getParsedText(i, m, _, s), f[_] = a, 
            C && "numeric" === (D[_].type || "").toLowerCase() && (x[_] = Math.max(Math.abs(a) || 0, x[_] || 0)), 
            (w = m.colSpan - 1) > 0)) {
              for (T = 0; T <= w; ) a = i.duplicateSpan || 0 === T ? s : "string" != typeof i.textExtraction && t.getElementText(i, m, _ + T) || "", 
              y.raw[_ + T] = a, f[_ + T] = a, T++;
              _ += w, S += w;
            }
            _++;
          }
      ...
      if (i.showProcessing && t.isProcessing(M), A) {
        for (k = Math.min(5, i.cache[0].normalized.length), console[console.group ? "group" : "log"]("Building cache for " + i.totalRows + " rows (showing " + k + " rows in log) and " + i.columns + " columns" + t.benchmark(g)), 
        s = {}, u = 0; u < i.columns; u++) for (_ = 0; _ < k; _++) s["row: " + _] || (s["row: " + _] = {}), 
  ...
  return function(e, t, i) {
    ...
    t.themes = {
      ...
      format: function(i, n, r) {
        var o, s, a, l, u, c, d, h, f, p, m, g, v, y = t.themes, b = n.$table.add(e(n.namespace + "_extra_table")), x = n.$headers.add(e(n.namespace + "_extra_headers")), w = n.theme || "jui", _ = y[w] || {}, C = e.trim([ _.sortNone, _.sortDesc, _.sortAsc, _.active ].join(" ")), S = e.trim([ _.iconSortNone, _.iconSortDesc, _.iconSortAsc ].join(" ")), k = t.debug(n, "uitheme");
        for (k && (u = new Date()), b.hasClass("tablesorter-" + w) && n.theme === n.appliedTheme && r.uitheme_applied || (r.uitheme_applied = !0, 
        ...
        d = t.css.icon ? c.find("." + t.css.icon) : e(), (f = x.not(".sorter-false").filter('[data-column="' + o + '"]:last')).length && (c.removeClass(C), 
        d.removeClass(S), f[0].sortDisabled ? d.removeClass(_.icons || "") : (a = _.sortNone, 
        ...
        k && console.log("uitheme >> Applied " + w + " theme" + t.benchmark(u));
      },
      remove: function(e, i, n, r) {
    ...
    e.extend(r, {
      ...
      findRows: function(r, o, s) {
        if (!t.equalFilters(r.config, r.config.lastSearch, s) && r.config.widgetOptions.filter_initialized) {
          var a, l, u, c, d, h, f, p, m, g, v, y, b, x, w, _, C, S, k, T, M, D, A, P = e.extend([], o), I = r.config, j = I.widgetOptions, E = n.debug(I, "filter"), F = {
            anyMatch: !1,
            filters: o,
            filter_regexCache: []
          }, O = {
            ...
            excludeFilter: [],
            defaultColFilter: [],
            defaultAnyFilter: n.getColumnData(r, j.filter_defaultFilter, I.columns, !0) || ""
          };
          for (F.parsed = [], m = 0; m < I.columns; m++) F.parsed[m] = j.filter_useParsedData || I.parsers && I.parsers[m] && I.parsers[m].parsed || n.getData && "parsed" === n.getData(I.$headerIndexed[m], n.getColumnData(r, I.headers, m), "filter") || I.$headerIndexed[m].hasClass("filter-parsed"), 
          O.functions[m] = n.getColumnData(r, j.filter_functions, m) || I.$headerIndexed[m].hasClass("filter-select"), 
          O.defaultColFilter[m] = n.getColumnData(r, j.filter_defaultFilter, m) || "", O.excludeFilter[m] = (n.getColumnData(r, j.filter_excludeFilter, m, !0) || "").split(/\s+/);
          for (E && (console.log("Filter >> Starting filter widget search", o), x = new Date()), 
          I.filteredRows = 0, I.totalRows = 0, s = P || [], f = 0; f < I.$tbodies.length; f++) {
            ...
            c = e(e.map(l, function(e) {
              return e[m].$row.get();
            })), "" === s.join("") || j.filter_serversideFiltering) c.removeClass(j.filter_filteredRow).not("." + I.cssChildRow).css("display", ""); else {
              if (a = (c = c.not("." + I.cssChildRow)).length, (j.filter_$anyMatch && j.filter_$anyMatch.length || "undefined" != typeof o[I.columns]) && (F.anyMatchFlag = !0, 
              F.anyMatchFilter = "" + (o[I.columns] || j.filter_$anyMatch && t.getLatestSearch(j.filter_$anyMatch).val() || ""), 
              j.filter_columnAnyMatch)) {
                for (k = F.anyMatchFilter.split(i.andSplit), T = !1, _ = 0; _ < k.length; _++) (M = k[_].split(":")).length > 1 && (isNaN(M[0]) ? e.each(I.headerContent, function(e, t) {
                  t.toLowerCase().indexOf(M[0]) > -1 && (o[D = e] = M[1]);
                }) : D = parseInt(M[0], 10) - 1, D >= 0 && D < I.columns && (o[D] = M[1], k.splice(_, 1), 
                _--, T = !0));
                T && (F.anyMatchFilter = k.join(" && "));
              }
              if (S = j.filter_searchFiltered, v = I.lastSearch || I.$table.data("lastSearch") || [], 
              S) for (_ = 0; _ < m + 1; _++) w = o[_] || "", S || (_ = m), S = S && v.length && 0 === w.indexOf(v[_] || "") && !i.alreadyFiltered.test(w) && !i.exactTest.test(w) && !(i.isNeg1.test(w) || i.isNeg2.test(w)) && !("" !== w && I.$filters && I.$filters.filter('[data-column="' + _ + '"]').find("select").length && !t.matchType(I, _));
              for (C = c.not("." + j.filter_filteredRow).length, S && 0 === C && (S = !1), E && console.log("Filter >> Searching through " + (S && C < a ? C : "all") + " rows"), 
              F.anyMatchFlag && (I.sortLocaleCompare && (F.anyMatchFilter = n.replaceAccents(F.anyMatchFilter)), 
              j.filter_defaultFilter && i.iQuery.test(O.defaultAnyFilter) && (F.anyMatchFilter = t.defaultFilter(F.anyMatchFilter, O.defaultAnyFilter), 
              S = !1), F.iAnyMatchFilter = j.filter_ignoreCase && I.ignoreCase ? F.anyMatchFilter.toLowerCase() : F.anyMatchFilter), 
              h = 0; h < a; h++) if (A = c[h].className, !(h && i.child.test(A) || S && i.filtered.test(A))) {
                if (F.$row = c.eq(h), F.rowIndex = h, F.cacheArray = l[h], u = F.cacheArray[I.columns], 
                F.rawArray = u.raw, F.childRowText = "", !j.filter_childByColumn) {
                  for (A = "", g = u.child, _ = 0; _ < g.length; _++) A += " " + g[_].join(" ") || "";
                  F.childRowText = j.filter_childRows ? j.filter_ignoreCase ? A.toLowerCase() : A : "";
                }
                if (y = !1, b = t.processRow(I, F, O), d = u.$row, w = !!b, g = u.$row.filter(":gt(0)"), 
                j.filter_childRows && g.length) {
                  if (j.filter_childByColumn) for (j.filter_childWithSibs || (g.addClass(j.filter_filteredRow), 
                  d = d.eq(0)), _ = 0; _ < g.length; _++) F.$row = g.eq(_), F.cacheArray = u.child[_], 
                  F.rawArray = F.cacheArray, w = t.processRow(I, F, O), y = y || w, !j.filter_childWithSibs && w && g.eq(_).removeClass(j.filter_filteredRow);
                  y = y || b;
                } else y = w;
                d.toggleClass(j.filter_filteredRow, !y)[0].display = y ? "" : "none";
              }
            }
            I.filteredRows += c.not("." + j.filter_filteredRow).length, I.totalRows += c.length, 
            n.processTbody(r, p, !1);
          }
          I.lastCombinedFilter = P.join(""), I.lastSearch = P, I.$table.data("lastSearch", P), 
          j.filter_saveFilters && n.storage && n.storage(r, "tablesorter-filters", t.processFilters(P, !0)), 
          E && console.log("Filter >> Completed search" + n.benchmark(x)), j.filter_initialized && (I.$table.triggerHandler("filterBeforeEnd", I), 
    ...
    e.extend(n.css, {
      ...
      format: function(r, o, s) {
        if (!(o.$table.hasClass("hasStickyHeaders") || e.inArray("filter", o.widgets) >= 0 && !o.$table.hasClass("hasFilters"))) {
          ...
          }), C = w.children("thead:first"), S = "", k = function(e, i) {
          ...
          w.find("caption").toggle(s.stickyHeaders_includeCaption), c = C.children().children(), 
          w.css({
            height: 0,
            width: 0,
            margin: 0
            ...
            M();
          }), n.bindEvents(r, C.children().children("." + n.css.header)), s.stickyHeaders_appendTo ? e(s.stickyHeaders_appendTo).append(_) : d.after(_), 
          o.onRenderHeader) for (l = (u = C.children("tr").children()).length, a = 0; a < l; a++) o.onRenderHeader.apply(u.eq(a), [ a, o, w ]);
...
//# sourceMappingURL=/assets/maps/application_vendor-617c711daff74c2b8627170730fe6031000c77e318d5c60fdb5c3440010658bb.js.map
